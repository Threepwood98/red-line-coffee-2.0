    ...
    >
      <div className="px-3 sm:px-6 py-3 sm:py-6 transition-all duration-300">
        ...
        <div className="flex flex-col items-center gap-2 sm:gap-3">
          <div className="aspect-square rounded-xl w-full overflow-hidden">
            <img
              src={
                imageError
          ...
          <span className="font-bebas-neue text-lg sm:text-xl text-accent-foreground">
            {product.nameJP}
          </span>
          <div
            className={cn(
